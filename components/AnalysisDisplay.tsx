                    ...
                    <div className="space-y-12">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <button 
                                    onClick={() => generateForensicPdf(res)}
                                    className="text-[8px] font-mono text-brand-clinical border border-brand-clinical px-3 py-1 rounded-md hover:bg-brand-clinical hover:text-white transition-colors uppercase"
                                >
                                    PDF_EXPORT
                                </button>
                                <button 
                                    onClick={() => exportJson(res, `Analyse_${new Date().toISOString()}`)}
